...
def train(**kwargs):
    ...
    if not os.path.exists('C:/Users/Huang Lab/Desktop/checkpoints/{}/{}--{}--{}/'.format(opt.model, opt.mark, opt.lr, opt.batch_size)):
        os.makedirs('C:/Users/Huang Lab/Desktop/checkpoints/{}/{}--{}--{}/'.format(opt.model, opt.mark, opt.lr, opt.batch_size))
    ...
    for epoch in range(opt.max_epoch):
        ...
        np.save('C:/Users/Huang Lab/Desktop/checkpoints/{}/{}--{}--{}/train_loss.npy'.format(opt.model, opt.mark, opt.lr,
                                                                                        opt.batch_size), train_loss)
        np.save('C:/Users/Huang Lab/Desktop/checkpoints/{}/{}--{}--{}/train_dice.npy'.format(opt.model, opt.mark, opt.lr,
                                                                                        opt.batch_size), train_DICE)
        np.save('C:/Users/Huang Lab/Desktop/checkpoints/{}/{}--{}--{}/val_dice.npy'.format(opt.model, opt.mark, opt.lr,
                                                                                      opt.batch_size), val_DICE)

        model.save(
            'C:/Users/Huang Lab/Desktop/checkpoints/{}/{}--{}--{}/{:0>4d}--{:.4f}--{:.4f}.pth'.format(
