                ...
                for test_names in os.listdir(test_path):
                    if '.DS_Store' not in test_names:
                        self.imgs_green.append(
                            test_path + '/' + test_names + '/' + test_names + opt.Vessel_images_name)
                ...
                for train_names in os.listdir(train_path):
                    if '.DS_Store' not in train_names:
                        self.imgs_red.append(
                            train_path + '/' + train_names + '/' + train_names + opt.FTn_images_name)
                        self.imgs_green.append(
                            train_path + '/' + train_names + '/' + train_names + opt.Vessel_images_name)
...
if __name__ == '__main__':
    ...
    test_data = dataset_vessel(train_data_root, test=True)
